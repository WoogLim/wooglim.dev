...
![instagramChat-1](/posts/artcle/socket/instagramChat-1.png)
...
![instagramChat-2](/posts/artcle/socket/instagramChat-2.png)

다음은 대상자 선택 후 채팅방이 개설된 모습입니다. 채팅 메시지 및 사진 그리고 이모티콘을 입력할 수 있습니다. 이 부분에서 메시지 전송 기능만을 구현하기로 했습니다.
![instagramChat-3](/posts/artcle/socket/instagramChat-3.png)

### 데이터 베이스 설계하기
---
위와 같은 모델을 분석하여 다음과 같이 데이터 베이스를 설계하였습니다. 
![instagramChatERD](/posts/artcle/socket/instagramChatERD.png)
