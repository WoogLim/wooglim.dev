...
### Nagative Prompt
![stable-diffusion-webui-prompt](/snippets/stableDiffusion/section1/nagative-prompt.png)

`Prompt`가 양이라면 `Nagative Prompt`는 음입니다. `Prompt`에서 제외하고 싶은 요소를 입력하여 조정이 가능합니다.

### Sampling method&step
![stable-diffusion-webui-prompt](/snippets/stableDiffusion/section1/sampling-method&step.png)
...
### Width&Height
![stable-diffusion-webui-prompt](/snippets/stableDiffusion/section1/width-height.png)
...
### Batch count
![stable-diffusion-webui-prompt](/snippets/stableDiffusion/section1/batch-count.png)
...
### Batch size
![stable-diffusion-webui-prompt](/snippets/stableDiffusion/section1/batch-size.png)
동시 생성할 이미지 매수입니다. `Batch count`와 달리 동시에 생성됩니다.

### CFG(Classifier-free Guidance) Scale
![stable-diffusion-webui-prompt](/snippets/stableDiffusion/section1/cfg-scale.png)
모델과 분류기를 동시에 학습하여 값이 클수록 이미지의 다양성은 사라지고 비슷한 이미지를 생성합니다. 낮추는 경우 다양한 이미지가 생성되나 입력 문자열에서 예상하기 어려운 이미지도 생성됩니다.

### Seed
![stable-diffusion-webui-prompt](/snippets/stableDiffusion/section1/seed.png)
...
### script
![stable-diffusion-webui-prompt](/snippets/stableDiffusion/section1/script.png)
...
### 생성된 이미지
![stable-diffusion-webui-prompt](/snippets/stableDiffusion/section1/gen-image.png)
