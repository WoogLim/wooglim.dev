---
title: "스프링 입문"
description: "스프링 입문 - 코드로 배우는 스프링 부트, 웹 MVC, DB 접근 기술 강의 정리 1일차"
language: "Java"
category: "Spring"
update: "2023-06-30"
serisenumber: 1
...
### InteliJ 설치
---
InteliJ는 우선 무료버전인 커뮤니티 버전으로 진행한다.
...
패키지는 Gradle Project가 대중적. 언어는 Java를 설정한다. 스프링 부트 버전은 강의상으론 `2.3.1`이지만 현재 시점 릴리즈된 기준 `3.1.1`버전을 사용하겠습니다.
...
이후 인텔리 J를 실행하여 `build.gradle`을 오픈합니다.
