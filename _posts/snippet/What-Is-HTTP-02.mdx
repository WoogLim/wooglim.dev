...
![HTTP-capture4](/snippets/http/http4.png)
...
![HTTP-capture5](/snippets/http/http5.png)
...
![HTTP-capture6](/snippets/http/http6.png)
...
![HTTP-capture7](/snippets/http/http7.png)

- 요청 메시지는 패킷에 포함되어 다음과 같이 만들어집니다.

![HTTP-capture8](/snippets/http/http8.png)
